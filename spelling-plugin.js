    ...
    waitForMainApp(function() {
        ...
        class SpellingPlugin {
            ...
            startTraining() {
                ...
                this.state.streak = 0;
                this.state.currentWord = null;
                const btn = document.getElementById('spellingModeBtn');
            ...
            updateSpellingDisplay() {
                ...
                let displayText = isEnToCn ? `📝 ${word.chinese}` : `🔤 ${word.english}`;
                let hintText = isEnToCn ? '请拼写对应的英文单词' : '请拼写对应的中文（拼音）';
            ...
            setHintLevel(level) {
                ...
                const hintEl = document.getElementById('spellHintLevel');
            ...
            renderStats() {
                ...
                const ids = ['spellCorrect', 'spellTotal', 'spellStreak', 'spellBest', 'spellAccuracy'];
                const values = [correct, total, this.state.streak, this.state.bestStreak, total > 0 ? `${accuracy}%` : '0%'];
                ids.forEach((id, i) => {
            ...
            updateDisplay(display, hint) {
                const d = document.getElementById('spellDisplay');
                const h = document.getElementById('spellHint');
